      ...
      {menuopen === false && mobile === true ?
        (
          ...
          <ul className='header-menu'>
            <li><Link onClick={()=>setMenuOpen(false)} to="header" span={true} smooth={true}> Home</Link> </li>
            ...
            <li ><Link onClick={()=>setMenuOpen(false)} to="testimonials" span={true} smooth={true}> Testmonials</Link></li>
          </ul>
        )}
    </div>
  )
